-- Standalone Setup Script for Rider Withdrawal Requests & Rider Settings
-- Run this script in your Supabase SQL Editor (https://supabase.com/dashboard)

-- 1. Create withdrawal_requests table for riders
...
-- 2. Create rider_settings table for profile & vehicle information
